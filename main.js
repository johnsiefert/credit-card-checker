...
validateCred(valid1)
 ...
 const idInvalidCardCompanies = (arr) => {
  ...
  switch(firstDigit){
  case 3:
  if(companyCard.indexOf('Amex') === -1){
  companyCard.push('Amex')
  }
break;
  case 4:
  if(companyCard.indexOf('Visa') === -1){
  companyCard.push('Visa')
  }
break;
  case 5:
   if(companyCard.indexOf('MasterCard') === -1){
  companyCard.push('MasterCard')
  }
break;
  case 6:
  if(companyCard.indexOf('Discover') === -1){
